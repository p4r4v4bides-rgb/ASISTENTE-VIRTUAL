  ...
  return (
    <div className="flex flex-col gap-6 w-full justify-center items-center">
      ...
      >
        ...
        <button className="bg-lime-600 hover:bg-lime-700 text-white font-bold py-4 px-4 rounded-2xl transition-all hover:shadow-lg hover:shadow-lime-600 text-xl">
          Registrarme en Tuke
        </button>
      </form>
      <button
